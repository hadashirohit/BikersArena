                       ...
                       <form action="AdminLogIn.jsp" method="post">
                        <div class="form-row">
                            <div class="col-lg-7">
                                ...
                                <input type="text" placeholder="Enter Name" name="aname" class="form-control my-3 p-3">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-lg-7">
                               
                                <input type="password" placeholder="********"  name="apass" class="form-control my-3 p-3">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-lg-7">
                                <button type="submit" class="btn1 mt-3 mb-5" name="submit">Sign in</button>
                            </div>
                        </div>
                       </form>
                    </div>
	 ...
	 if(request.getParameter("submit") != null)
	 {
		 String aname = request.getParameter("aname");
			...
			try 
			{
				...
				PreparedStatement ps = con.prepareStatement("select * from adminlogin where admin_name= ? and admin_pass = ? ");
