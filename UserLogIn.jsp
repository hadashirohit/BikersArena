                       ...
                       <form action="UserLogIn.jsp" method="post">
                        <div class="form-row">
                            <div class="col-lg-7">
                                ...
                                <input type="email" name="username" placeholder="Enter Email" class="form-control my-3 p-3">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-lg-7">
                               
                                <input type="password" name="userpass" placeholder="********" class="form-control my-3 p-3">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-lg-7">
                                <button type="submit" name="submit" class="btn1 mt-3 mb-5">Sign in</button>
                            </div>
                        </div>
                        <a href="#">Forgot Password?</a>
                        <p>Dont't have an account? <a href="Registration.jsp">Register here</a> </p>
                       </form>
                    </div>
                </div>
            </div>
	 ...
	 if(request.getParameter("submit") != null)
	 {
		 String uemail = request.getParameter("username");
			...
			try 
			{
				...
				Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/bikers_arena?useSSL=false", "root","");
				PreparedStatement ps = con.prepareStatement("select * from user_register where u_email= ? and u_pass = ? ");
