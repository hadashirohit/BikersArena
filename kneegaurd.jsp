...
<head>
<meta charset="UTF-8">
<title>KneeGuard - Biker's Arena</title>
...
<% 
	try{
		...
		String qry = "select * from product_kneegaurd";
       			...
       			out.print("<div class='card'>");
       				...
       				out.print("<div class='card-footer'>");
       					...
       					out.print("MRP inclusive all taxes</span></small>");
       						out.print("<form action='insertCart.jsp'>");
					       		out.print("<input type='hidden' name='product_brand' value='"+rs.getString(2)+"'>");
					       		...
					       		out.print("<input type='submit' value='Add to cart' class='btn btn-warning float-end' name='add'");
					       	out.print("</form>");
       				out.print("</div>");
       			out.print("</div>");
       		out.print("</div>");
